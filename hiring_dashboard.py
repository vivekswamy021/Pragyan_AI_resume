...
def hiring_dashboard(go_to_func):
    ...
    with col_title:
        ...
        st.caption("Manage Job Descriptions and track hiring metrics.")
    ...
    tab_jd_mgmt, tab_stats = st.tabs(["📄 JD Management", "📊 Hiring Analytics"])
    ...
    with tab_stats:
        ...
        m2.metric("Approved Candidates", approved)
