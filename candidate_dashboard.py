...
def generate_cv_html(parsed_data):
    ...
    # Added GitHub and LinkedIn to CV Management Form, ensuring they are used here
...
def cv_management_tab_content():
    ...
    with st.form("cv_builder_form"):
        ...
        # Row 2: LinkedIn, GitHub (Added/Confirmed)
    ...
    if st.session_state.get('parsed', {}).get('name'):
        ...
        def format_parsed_json_to_markdown(parsed_data):
            ...
            if parsed_data.get('github'): contact_info.append(f"[GitHub]({parsed_data['github']})") # Added/Confirmed GitHub
...
def filter_jd_tab_content():
    ...
    if not st.session_state.candidate_jd_list:
        st.info("No Job Descriptions are currently loaded. Please add JDs in the 'JD Management' tab (Tab 3).")
...
def candidate_dashboard():
    ...
    # Main Content Tabs (REARRANGED TABS HERE to move Q&A and Interview Prep to last)
    ...
    # --- TAB 5: Resume/JD Chatbot (Q&A) (MOVED TO LAST SECOND) ---
    with tab_chatbot:
    ...
    # --- TAB 6: Interview Prep (MOVED TO LAST) ---
